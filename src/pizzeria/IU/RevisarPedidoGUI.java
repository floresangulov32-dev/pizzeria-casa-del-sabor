...
public class RevisarPedidoGUI extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(RevisarPedidoGUI.class.getName());
    ...
    public RevisarPedidoGUI(String rol, String nombre) {
    initComponents();
    setSize(1280, 720);
    setLocationRelativeTo(null);
    Encabezado.setPreferredSize(new java.awt.Dimension(1280, 100));
    ...
    private void initComponents() {
        ...
        jButton1.setText("COBRAR PEDIDO");
        ...
        jLabel9.setText("ÍTEMS DEL PEDIDO ACTUAL");

        jTable1.setFont(new java.awt.Font("Liberation Sans", 0, 13)); // NOI18N
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Pizza Hawaiana", "1", "Bs. 35", "Bs. 35"},
                {"Gaseosa 1.5 L", "2", "Bs. 10", "Bs. 20"},
                {"Combo Personal", "1", "Bs. 45", "Bs. 45"}
            },
            new String [] {
                "Producto / Combo", "Cantidad", "Precio Unit.", "Subtotal"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new RevisarPedidoGUI().setVisible(true));
    }
