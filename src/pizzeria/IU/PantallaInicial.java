...
public class PantallaInicial extends javax.swing.JFrame {
    ...
    private void cargarImagenes() {
        try {            
            ...
            if (archivoLogo.exists()) {
                ImageIcon logoIcon = new ImageIcon(archivoLogo.getAbsolutePath());
                logoImagen = logoIcon.getImage();
                System.out.println("Logo cargado desde: " + archivoLogo.getAbsolutePath());
            } else {
                System.out.println("No se encontró el archivo en: " + archivoLogo.getAbsolutePath());
            }
        } catch (Exception e) {
    ...
    private void configurarCabecera() {    
        ...
        jPanel1.setBorder(BorderFactory.createEmptyBorder(15, 20, 10, 20));
        ...
        if (logoImagen != null) {        
            Image logoEscalado = logoImagen.getScaledInstance(200, 100, Image.SCALE_SMOOTH);
    ...
    private void configurarBotones(){
        ...
        jButton1.setBackground(new Color(180, 0, 0));
        ...
        jButton1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                jButton1.setBackground(new Color(220, 0, 0));
            }
        ...
        jButton2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                jButton2.setBackground(new Color(180, 30, 30));
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                jButton2.setBackground(new Color(150, 0, 0));
            }
        ...
        jButton3.setBackground(new Color(40, 40, 40));
        ...
        jButton3.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                jButton3.setBackground(new Color(80, 0, 0));
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                jButton3.setBackground(new Color(40, 40, 40));
            }
