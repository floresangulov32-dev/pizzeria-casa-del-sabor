...
public class ContextoVentasGUI {
    ...
    public void mostrarCantidadVentas() {
        ...
        System.out.println("Total ventas cargadas: " + gestorVenta.getListaVenta().size());
        for (Venta v : gestorVenta.getListaVenta()) {
            System.out.println("Venta ID: " + v.getId() + " - Fecha: " + v.getFecha() + " - Total: " + v.getTotal());
        }
    }
}*/
